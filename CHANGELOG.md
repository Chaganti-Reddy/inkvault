...
- **Drawing aids & clipboard** — hold Shift while drawing to constrain (lines snap to 45°, rectangles/highlights become squares, ellipses become circles), and duplicate, copy or paste any annotation with Ctrl/Cmd+D, Ctrl/Cmd+C and Ctrl/Cmd+V.
